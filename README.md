...
```
[Opus 4.6] 📁 ~/Projects/my-project | 🔗 OFurtun/my-project | 🌿 main | 🟢 120K/200K (60%) | 🕐 Started 15m ago | 🪙 45K↓ 12K↑ | 💲0.42 | 📊 Used: 47K (23%) | 🔒 Compaction Buffer: 33K (~16%) | 💾 Cache Read: 7.7M | Cache Write: 1.2K | ✏️ Total Lines +234/-89
```
